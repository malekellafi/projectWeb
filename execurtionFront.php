                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="products.html">Nos musées</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="detailsExecurtion.php?nom=<?php echo $exec['nom']; ?>&prix=<?php echo $exec['prix']; ?>&desc=<?php echo $exec['description']; ?>&img=<?php echo $exec['image']; ?>"">
                                    <img src="images/product/<?php echo $exec['image']; ?>" class="img-fluid product-image" alt="">
                                </a>

                                <div class="product-top d-flex">
                                    <span class="product-alert me-auto">Réserver</span>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="detailsExecurtion.php?nom=<?php echo $exec['nom']; ?>&prix=<?php echo $exec['prix']; ?>&desc=<?php echo $exec['description']; ?>&img=<?php echo $exec['image']; ?>" class="product-title-link"><?php echo $exec['nom']; ?></a>
                                        </h5>
