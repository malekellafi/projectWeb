        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>                
                    ...
                    <h2>Ajouter une exécurtion</h2>
                    <br>
                        <form action="ajoutFunction.php" method="post" id="execForm">
                    ...
                    myForm.addEventListener('submit' , function(e){
                      ...
                      if(date.value=='')
                      {
                        ...
                        error.style.color = 'red';
                        e.preventDefault();
                      } else if (new Date(date.value) <= dateTest)
                      {
                        alert("Exécution date non valide !");
                        e.preventDefault();
                      }
                      if(image.value=='')
                      {
                        let error = document.getElementById('errorimg');
                        error.innerHTML = "Le champs image est obligatoire";
                        error.style.color = 'red';
                        e.preventDefault();
                      }
