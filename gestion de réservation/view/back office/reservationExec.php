...
require('../../controller/ReservationC.php');
    ...
    $listExec = $resC->joinExec($_GET['id']);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Listes des réservations</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="ajoutExecurtion.php">Ajouter une exécurtion</a></li>
                            <li class="breadcrumb-item"><a href="afficherBackExec.php">Listes des exécurtions</a></li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    foreach($listExec as $exec) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $exec['id_rsv']; ?></td>
                                            <td><?php echo $exec['date_depart']; ?></td>
                                            <td><?php echo $exec['date_reservation']; ?></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
