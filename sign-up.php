                        ...
                        <div class="col-lg-8 mx-auto col-12">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-11 mx-auto">
                                    <form action="../back office/admin/traitementAjoutUser.php" method="POST">
                                    ...
                                    <div class="form-floating mb-4 p-0">
                                        ...
                                        <div class="form-floating my-4">
                                            <input type="password" name="mdp" id="mdp" pattern="[0-9a-zA-Z]{4,10}" class="form-control" placeholder="Password" required>
                                        ...
                                        <div class="form-floating">
                                            <input type="password" name="Cmdp" id="Cmdp" pattern="[0-9a-zA-Z]{4,10}" class="form-control" placeholder="Password" required>

                                            <label for="Cmdp">Confirmer le mot de passe</label>
                                        </div>

                                        <button type="submit" value="Ajouter" class="btn custom-btn form-control mt-4 mb-3" >
                                            Create account
                                        </button>
